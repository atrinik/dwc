 ...
 */
public class ScriptHelp extends JFrame {
     ...
     */
    public ScriptHelp (JFrame main_view, String fname, boolean big_size) {
        super("Script Help");    // super constructor
        ...
        if (fname == null) fname = "pystart.html";
        HtmlPane html;
